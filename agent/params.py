class Params:
    ...
    TAU = 0.0001 # Valeur typique entre 0.001 et 0.01
    ...
    TRAINING_FREQUENCY_STEPS = 1       # Entraînement toutes les 4 étapes [cite: 265]
    ...
    NUM_EPISODES = 40000 #40000   # Le rapport utilise 30000-40000 epochs pour la convergence
    MAX_STEPS_PER_EPISODE = 150 # Étapes fixées pour l'entraînement [cite: 163]
